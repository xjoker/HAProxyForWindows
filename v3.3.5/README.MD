# HAProxy 3.3.5 for Windows

## Source code
https://www.haproxy.org/download/3.3/src/haproxy-3.3.5.tar.gz
...
## Build info
```
HAProxy version 3.3.5-f0a2d1bf5 2026/03/09 - https://haproxy.org/
Status: stable branch - will stop receiving fixes around Q1 2027.
Known bugs: http://www.haproxy.org/bugs/bugs-3.3.5.html
