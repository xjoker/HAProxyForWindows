# HAProxy 2.4.6 for windows

## Source code
http://www.haproxy.org/download/2.4/src/haproxy-2.4.6.tar.gz
## Build parameters
```
...
## Build info
```
HAProxy version 2.4.6-d83fd76 2021/10/04 - https://haproxy.org/
Status: long-term supported branch - will stop receiving fixes around Q2 2026.
Known bugs: http://www.haproxy.org/bugs/bugs-2.4.6.html
