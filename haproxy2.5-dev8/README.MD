# HAProxy 2.5-dev8 for windows

## Source code
http://www.haproxy.org/download/2.5/src/devel/haproxy-2.5-dev8.tar.gz
## Build parameters
```
...
## Build info
```
HAProxy version 2.5-dev8-538f3e0 2021/09/24 - https://haproxy.org/
