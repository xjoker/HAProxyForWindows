# HAProxy 3.4-dev2 for Windows

## Source code
https://www.haproxy.org/download/3.4/src/devel/haproxy-3.4-dev2.tar.gz
...
## Build info
```
HAProxy version 3.4-dev2-71b00a9 2026/01/07 - https://haproxy.org/
