# HAProxy 2.6-dev5 for windows

## Source code
http://www.haproxy.org/download/2.6/src/devel/haproxy-2.6-dev5.tar.gz
## Build parameters
```
...
## Build info
```
HAProxy version 2.6-dev5-d3b4cd1 2022/04/09 - https://haproxy.org/
