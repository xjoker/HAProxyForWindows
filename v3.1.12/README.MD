# HAProxy 3.1.12 for windows

## Source code
https://www.haproxy.org/download/3.1/src/haproxy-3.1.12.tar.gz
...
## Build info
```
HAProxy version 3.1.12-768679d 2025/12/22 - https://haproxy.org/
Status: stable branch - will stop receiving fixes around Q1 2026.
Known bugs: http://www.haproxy.org/bugs/bugs-3.1.12.html
