# HAProxy 3.3.12 for Windows

## Source code
https://www.haproxy.org/download/3.3/src/haproxy-3.3.12.tar.gz
...
## Build info
```
HAProxy version 3.3.12-e5c37c585 2026/07/03 - https://haproxy.org/
Status: stable branch - will stop receiving fixes around Q1 2027.
Known bugs: http://www.haproxy.org/bugs/bugs-3.3.12.html
