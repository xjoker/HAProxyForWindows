# HAProxy 3.3.13 for Windows

## Source code
https://www.haproxy.org/download/3.3/src/haproxy-3.3.13.tar.gz
...
## Build info
```
HAProxy version 3.3.13-f0df3469b 2026/07/29 - https://haproxy.org/
Status: stable branch - will stop receiving fixes around Q1 2027.
Known bugs: http://www.haproxy.org/bugs/bugs-3.3.13.html
