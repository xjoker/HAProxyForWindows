# HAProxy 3.3.9 for Windows

## Source code
https://www.haproxy.org/download/3.3/src/haproxy-3.3.9.tar.gz
...
## Build info
```
HAProxy version 3.3.9-aa6f85a2f 2026/05/06 - https://haproxy.org/
Status: stable branch - will stop receiving fixes around Q1 2027.
Known bugs: http://www.haproxy.org/bugs/bugs-3.3.9.html
