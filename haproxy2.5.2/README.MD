# HAProxy 2.5.2 for windows

## Source code
http://www.haproxy.org/download/2.5/src/haproxy-2.5.2.tar.gz
## Build parameters
```
...
## Build info
```
HAProxy version 2.5.2-042feec 2022/02/16 - https://haproxy.org/
Status: stable branch - will stop receiving fixes around Q1 2023.
Known bugs: http://www.haproxy.org/bugs/bugs-2.5.2.html
