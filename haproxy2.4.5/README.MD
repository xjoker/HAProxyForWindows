# HAProxy 2.4.5 for windows

## Source code
http://www.haproxy.org/download/2.4/src/haproxy-2.4.5.tar.gz
## Build parameters
```
...
## Build info
```
HAProxy version 2.4.5-e74a1b3 2021/10/01 - https://haproxy.org/
Status: long-term supported branch - will stop receiving fixes around Q2 2026.
Known bugs: http://www.haproxy.org/bugs/bugs-2.4.5.html
