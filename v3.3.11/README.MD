# HAProxy 3.3.11 for Windows

## Source code
https://www.haproxy.org/download/3.3/src/haproxy-3.3.11.tar.gz
...
## Build info
```
HAProxy version 3.3.11-e6dcdf2a4 2026/06/26 - https://haproxy.org/
Status: stable branch - will stop receiving fixes around Q1 2027.
Known bugs: http://www.haproxy.org/bugs/bugs-3.3.11.html
