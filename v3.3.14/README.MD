# HAProxy 3.3.14 for Windows

## Source code
https://www.haproxy.org/download/3.3/src/haproxy-3.3.14.tar.gz
...
## Build info
```
HAProxy version 3.3.14-5e36a06 2026/08/27 - https://haproxy.org/
Status: stable branch - will stop receiving fixes around Q1 2027.
Known bugs: http://www.haproxy.org/bugs/bugs-3.3.14.html
